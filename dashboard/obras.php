...
<?php
    ...
    require_once("../controllers/animacoes.php");
    ...
    $listaObras = array_merge($listaAnimes, $listaAnimacoes);

    usort($listaObras, 'comparadorObras');
    ...
    <section class="content">
        <div class="container-fluid" id="mainContentDash">
            ...
            <div class="row clearfix" style="margin: 35px 0px;">
                <div class="col-sm-12">
                    <div class="botoesTop">
                        <a href="novoAnime.php" class="btn btnGod">Novo Anime</a>
                        <a href="#" class="btn btnGod">Nova Animação</a>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$obra->nome?></td>
                                            <td><?=$obra->tipo?></td>
                                            <td><a href="addGenero.php?id=<?=$obra->id?>" class="btn btnGod">Editar Gêneros</a></td>
                                            <td><a href="#" class="btn btnGod">Editar Obra</a></td>
                                        </tr>
                                        <?php
                                            }
                                        ?>
